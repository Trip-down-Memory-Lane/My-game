...
public class BadGuy extends Sprite {
    ...
    private static int stepX;   // Stores the 4 at which BadGuy is moving and occasionaly gives control over direction (positive and negative values).
